...
|---|---|---|---|---|
| `sos` | Emergency SOS | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / explicit |
| `sos-row-64` | Settings.SOS > -64 | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | row / explicit |
