# HomeScreenAndAppLibrary Settings routes
...
|---|---|---|---|---|
| `home-screen-and-app-library` | Home Screen & App Library | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
