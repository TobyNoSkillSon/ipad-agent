# MultitaskingAndGestures Settings routes
...
|---|---|---|---|---|
| `multitasking-and-gestures` | Settings.Multitasking And Gestures | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
