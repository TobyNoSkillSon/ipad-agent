# InternetAccounts Settings routes
...
|---|---|---|---|---|
| `internet-accounts-empty` | Settings.Internet Accounts > | **template** | runtime-literal (iOS 26.5 simulator, 23F77) | dynamic / blocked |
| `internet-accounts-placeholder` | Settings.Internet Accounts > % | **template** | runtime-literal (iOS 26.5 simulator, 23F77) | dynamic / blocked |
