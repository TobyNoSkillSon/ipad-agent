...
|---|---|---|---|---|
| `stand-by` | StandBy | **incompatible** | runtime-literal (iOS 26.5 simulator, 23F77)<br>profile-capability-mismatch (standby required=true, observed=false; scope iPad17,1 / J817AP / 23G83) | page / normal |
| `stand-by-always-on-display-options` | StandBy > Display device specific | **incompatible** | runtime-literal (iOS 26.5 simulator, 23F77)<br>user-visual-fail (actor=user; Settings launched; Apple Intelligence & Siri remained visible; scope iPad17,1 / J817AP / 23G83)<br>profile-capability-mismatch (standby required=true, observed=false; scope iPad17,1 / J817AP / 23G83) | page / normal |
