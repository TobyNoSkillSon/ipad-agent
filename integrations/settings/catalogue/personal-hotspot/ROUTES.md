# PersonalHotspot Settings routes
...
|---|---|---|---|---|
| `personal-hotspot` | Personal Hotspot | **incompatible** | runtime-literal (iOS 26.5 simulator, 23F77)<br>profile-capability-mismatch (personal_hotspot required=true, observed=false; scope iPad17,1 / J817AP / 23G83) | page / normal |
