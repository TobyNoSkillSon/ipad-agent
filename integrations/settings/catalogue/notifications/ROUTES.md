...
|---|---|---|---|---|
| `notifications` | Notifications | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
| `notifications-notification-forwarding-id` | Settings.Notifications > NOTIFICATION FORWARDING ID | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
