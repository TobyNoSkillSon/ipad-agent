# ExposureNotifications Settings routes
...
|---|---|---|---|---|
| `exposure-notifications` | Settings.Exposure Notifications | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
