...
|---|---|---|---|---|
| `game-center` | Game Center | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / explicit |
| `game-center-invite-friends` | Game Center > Invite Friends | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | action / blocked |
