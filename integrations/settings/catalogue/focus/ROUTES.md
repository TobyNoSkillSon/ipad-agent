...
|---|---|---|---|---|
| `focus` | Focus | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
| `focus-empty` | Settings.Focus > | **template** | runtime-literal (iOS 26.5 simulator, 23F77) | dynamic / blocked |
| `focus-focus` | Settings.Focus > Focus | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |
