...
|---|---|---|---|---|
| `family` | Family | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / explicit |
| `family-query-family-path-members` | Settings.Family > family Path= > members > | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / explicit |
| `family-query-family-path-subscriptions` | Family > Subscriptions | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / blocked |
