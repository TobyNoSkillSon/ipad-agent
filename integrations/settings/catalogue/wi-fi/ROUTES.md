...
|---|---|---|---|---|
| `wi-fi` | Wi-Fi | **proven** | runtime-literal (iOS 26.5 simulator, 23F77)<br>user-visual-pass (actor=user; expected-target-visible; scope iPad17,1 / J817AP / 23G83)<br>observer-screenshot-pass (actor=agent; method=project-owned-wda-screenshot; expected-target-visible; scope iPad17,1 / J817AP / 23G83) | page / normal |
| `wi-fi-wireless-app-data-usage-id` | Settings.Wi Fi > WIRELESS APP DATA USAGE ID | **candidate** | runtime-literal (iOS 26.5 simulator, 23F77) | page / normal |

Ordinary exact-scope example:

```python
ipadsettings("show", "wi-fi")
```
