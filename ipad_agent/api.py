...
from . import runtime
from .coredevice import IPadControlError
from .display import IPadShowError, show as _show
...
def show(
    ...
    except (IPadShowError, IPadControlError, OSError, TimeoutError, ValueError) as error:
