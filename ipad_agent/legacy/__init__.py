    ...
    with _context_lock:
        ...
        try:
            ...
            try:
                ...
                from ipad_agent.core.registry import AddonNotEnabledError, normalize_name
...
def ipad(*args: object, **options: object):
    ...
    from ipad_agent.core.results import ipad as execute
...
def show(*args: object, **options: object):
    ...
    if context is None:
        return _configuration_failure()
    from ipad_agent.core.results import show as display
